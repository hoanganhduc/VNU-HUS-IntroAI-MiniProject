...
\begin{center}
    ...
    \begin{tabular}{rl}
        ...
        \textbf{Báo cáo PDF:} & \href{[PDF Link]}{Liên kết tới báo cáo PDF trong kho GitHub} (ví dụ: \href{https://github.com/yourgithubname/yourgithubrepo/blob/master/report.pdf}{text})\\
        \textbf{Slide thuyết trình:} & \href{[Slides Link]}{Liên kết tới slide thuyết trình trong kho GitHub} (ví dụ: \href{https://github.com/yourgithubname/yourgithubrepo/blob/master/slides.pdf}{text}) \\
        \textbf{Kho GitHub:} & \url{[GitHub Repository URL]} (ví dụ: \url{https://github.com/yourgithubname/yourgithubrepo})
    \end{tabular}
    \\[2em]
    {\Large \textbf{Tên nhóm}}\\[1em]
...
\chapter*{Tóm tắt}
[Một trang tóm tắt ngắn gọn về dự án: mục tiêu, phương pháp, kết quả và kết luận.]
