...
\begin{center}
    ...
    \begin{tabularx}{\textwidth}{rX}
        ...
        \textbf{Báo cáo PDF:} & [Liên kết tới báo cáo PDF trong kho GitHub] (ví dụ: \url{https://github.com/yourgithubname/yourgithubrepo/blob/master/report.pdf})\\
        \textbf{Slide thuyết trình:} & [Liên kết tới slide thuyết trình trong kho GitHub] (ví dụ: \url{https://github.com/yourgithubname/yourgithubrepo/blob/master/slides.pdf}) \\
        \textbf{Kho GitHub:} & [Link đến kho GitHub] (ví dụ: \url{https://github.com/yourgithubname/yourgithubrepo})
    \end{tabularx}
    \\[2em]
    {\Large \textbf{[Tên nhóm] (e.g., Nhóm 1)}}\\[1em]
