...
\begin{center}
    ...
    \begin{tabularx}{\textwidth}{rX}
        ...
        \textbf{PDF Report:} & [Link to PDF report in GitHub repository] (e.g., \url{https://github.com/yourgithubname/yourgithubrepo/blob/master/report.pdf}) \\
        \textbf{Presentation Slides:} & [Link to presentation slides in GitHub repository] (e.g., \url{https://github.com/yourgithubname/yourgithubrepo/blob/master/slides.pdf}) \\
        \textbf{GitHub Repository:} & [GitHub Repository URL] (e.g., \url{https://github.com/yourgithubname/yourgithubrepo})
    \end{tabularx}
    \\[2em]
