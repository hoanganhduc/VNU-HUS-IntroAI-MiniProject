> ⚠️ **Remark:** This repository is created for the "Introduction to Artificial Intelligence" course at VNU-HUS which I have participated in as a Lecturer. It serves as a template for students to submit their mini-project reports and presentations. The content is provided in both English and Vietnamese. For a guideline on how to submit your mini-project, please refer to the [Submission Guide](SubmissionGuide.md).
>
> ⚠️ **Ghi chú:** Kho lưu trữ này được xây dựng để phục vụ cho môn "Nhập môn Trí tuệ Nhân tạo" tại VNU-HUS mà tôi tham gia với vai trò Giảng viên. Đây là một mẫu để sinh viên nộp báo cáo và slide trình bày bài tập nhóm. Nội dung được cung cấp bằng cả tiếng Anh và tiếng Việt. Để biết hướng dẫn nộp bài tập nhóm, vui lòng tham khảo [Hướng dẫn nộp bài](SubmissionGuide.md).
>
...
*Template last updated: 🗓️ December 2025*
...
*Mẫu cập nhật lần cuối: 🗓️ Tháng 12/2025*
